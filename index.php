...
<body>
    ...
    <div class="main-content" id="mainContent">
                        ...
                        <div class="chat-message ai-message">
                            ...
                            <div class="chat-content">
                                ...
                                <div class="chat-text" id="welcomeMessage">
                                    Olá! Eu sou o Reelmi AI. Como posso ajudar você hoje? Pode me fazer qualquer pergunta sobre IA, programação, análise de dados, ou qualquer outro tópico!
                                </div>
        ...
        <div class="container" id="mainContainer">
            ...
            <header class="header" role="banner">
                ...
                <p id="headerDescription">Uma noite perfeita para conversar com IA. Em que posso ser útil?</p>
            ...
            <main role="main">
                ...
                <section class="shortcuts-section" aria-labelledby="shortcutsTitle">
                    ...
                    <div class="shortcuts">
                        <button class="shortcut" data-action="questions" aria-label="Fazer perguntas">
                            <i class="fas fa-search"></i> Perguntas
                        </button>
                        <button class="shortcut" data-action="image" aria-label="Criar imagem">
                            <i class="fas fa-palette"></i> Criar Imagem
                        </button>
                        <button class="shortcut" data-action="solve" aria-label="Resolver problemas">
                            <i class="fas fa-brain"></i> Resolver Problemas
                        </button>
                        <button class="shortcut" data-action="analyze" aria-label="Analisar documento">
                            <i class="fas fa-file-alt"></i> Analisar Documento
                        </button>
                        <button class="shortcut" data-action="code" aria-label="Programar">
                            <i class="fas fa-code"></i> Programar
                        </button>
                    </div>
                </section>
            ...
            <footer class="footer" role="contentinfo">
                ...
                <p style="margin-top: 12px; font-size: 12px; color: var(--text-muted);">
                    ...
                    <span style="display: block; margin-top: 4px; font-size: 11.5px;">
                        Interface universal de inteligência artificial.
                    </span>
                </p>
            </footer>
        </div>
    ...
    <script>
    // APLICAÇÃO PRINCIPAL (ATUALIZADA COM BOTÃO DE FECHAR SIDEBAR)
    class AIChatInterface {
        constructor() {
            ...
            this.placeholderPhrases = [
                "Pergunte sobre IA...",
                "Peça para escrever um e-mail...",
                "Solicite uma análise de dados...",
                "Peça uma receita culinária...",
                "Solicite um plano de exercícios...",
                "Peça uma explicação sobre um conceito...",
                "Solicite ajuda com programação...",
                "Peça para criar uma imagem..."
            ];
            
            this.shortcutActions = {
                questions: {
                    placeholder: "Modo de perguntas ativado. O que você gostaria de saber?",
                    message: "Modo de perguntas ativado!"
                },
                image: {
                    placeholder: "Modo de criação de imagens ativado. Descreva a imagem que deseja criar.",
                    message: "Modo de criação de imagens ativado!"
                },
                solve: {
                    placeholder: "Modo de resolução de problemas ativado. Descreva o problema.",
                    message: "Modo de resolução de problemas ativado!"
                },
                analyze: {
                    placeholder: "Modo de análise de documentos ativado. Envie o documento.",
                    message: "Modo de análise de documentos ativado!"
                },
                code: {
                    placeholder: "Modo de programação ativado. Descreva o código que precisa.",
                    message: "Modo de programação ativado!"
                }
            };
        ...
        setupGreeting() {
            ...
            if (hour < 12) {
                ...
                description = "Comece seu dia com inteligência artificial. O que vamos criar hoje?";
            } else if (hour < 18) {
                greetingText = "Boa tarde, como posso ajudar?";
                iconGradient = "linear-gradient(135deg, #00dbde 0%, #fc00ff 100%)";
                description = "Explore as melhores plataformas de IA do mercado ou inicie uma conversa inteligente abaixo";
            } else {
                greetingText = "Boa noite, como posso ajudar?";
                iconClass = "fas fa-moon";
                iconGradient = "linear-gradient(135deg, #667eea 0%, #764ba2 100%)";
                description = "Uma noite perfeita para conversar com IA. Em que posso ser útil?";
            }
        ...
        toggleHeyReelmi() {
            ...
            if (this.state.heyReelmiActive) {
                ...
                setTimeout(() => {
                    this.showNotification(
                        'Ouvindo...', 
                        'Digite ou fale seu comando. O sistema está ouvindo ativamente.',
                        'info',
                        'fa-microphone'
                    );
                }, 1000);
        ...
        openFullscreenChat() {
            ...
            this.showNotification('Chat Inteligente', 'Bem-vindo ao chat da Reelmi AI!', 'success', 'fa-comment-dots');
        }
        ...
        toggleVoice() {
            ...
            if (this.state.voiceActive) {
                ...
                this.showNotification('Voz ativada', 'Reconhecimento de voz ativado. Fale agora...', 'info', 'fa-microphone');
                
                setTimeout(() => {
                    const voiceCommands = [
                        "Olá, como posso ajudar?",
                        "Pesquisar por inteligência artificial",
                        "Criar uma imagem de um paisagem montanhosa",
                        "Escrever um e-mail para agradecer a entrevista"
                    ];
                    const randomCommand = voiceCommands[Math.floor(Math.random() * voiceCommands.length)];
                    this.showNotification('Comando de voz', `Reconhecido: "${randomCommand}"`, 'success', 'fa-microphone');
                    this.elements.chatInput.value = randomCommand;
                }, 2000);
            } else {
        ...
        toggleFullscreenVoice() {
            ...
            if (this.state.fullscreenVoiceActive) {
                ...
                this.elements.fullscreenVoiceBtn.innerHTML = '<i class="fas fa-microphone-slash"></i>';
                ...
                setTimeout(() => {
                    ...
                    const randomCommand = voiceCommands[Math.floor(Math.random() * voiceCommands.length)];
                    this.showNotification('Comando de voz', `Reconhecido: "${randomCommand}"`, 'success', 'fa-microphone');
                    this.elements.fullscreenChatInput.value = randomCommand;
                }, 2000);
            } else {
        ...
        sendMessage() {
            ...
            if (message) {
                this.showNotification('Mensagem enviada', `"${message}"<br><small>Processando resposta...</small>`, 'info', 'fa-paper-plane');
                
                setTimeout(() => {
                    const responses = [
                        "Entendi sua pergunta! Aqui está a resposta...",
                        "Processei sua solicitação. Aqui estão os resultados:",
                        "Com base na sua pergunta, aqui está minha análise:",
                        "Ótima pergunta! Deixe-me explicar isso para você."
                    ];
                    const randomResponse = responses[Math.floor(Math.random() * responses.length)];
                    this.showNotification('Resposta recebida', randomResponse, 'success', 'fa-robot');
                }, 2000);
        ...
        sendFullscreenMessage() {
            ...
            setTimeout(() => {
                ...
                this.addFullscreenMessage('ai', this.generateAIReply(message));
        ...
        generateAIReply(userMessage) {
            const responses = {
                ...
                question: [
                    ...
                    "Baseado na minha base de conhecimento, posso dizer que...",
                    "Vou analisar sua pergunta e fornecer a melhor resposta possível."
                ],
                code: [
                    "Aqui está um exemplo de código para ajudar você:",
                    "Vou criar uma solução para o seu problema de programação:",
                    "Baseado no seu requisito, sugiro o seguinte código:"
                ],
                default: [
                    "Entendi sua mensagem! Posso ajudar com diversas tarefas como programação, análise de dados, redação, planejamento e muito mais.",
                    "Interessante! Posso elaborar mais sobre isso se você quiser.",
                    "Vou processar sua solicitação e fornecer a melhor assistência possível."
                ]
            };
            ...
            if (lowerMessage.includes('oi') || lowerMessage.includes('olá') || lowerMessage.includes('ola')) {
                category = 'greeting';
            } else if (lowerMessage.includes('?') || lowerMessage.includes('como') || lowerMessage.includes('por que')) {
                category = 'question';
            } else if (lowerMessage.includes('código') || lowerMessage.includes('codigo') || 
                       lowerMessage.includes('programar') || lowerMessage.includes('javascript') || 
            ...
            if (category === 'code') {
                const codeExample = `// Exemplo de função JavaScript
function exemplo() {
...
// Chamando a função
exemplo();`;
                return `${randomResponse}\n\n\`\`\`javascript\n${codeExample}\n\`\`\`\nIsso é apenas um exemplo. Posso gerar código em várias linguagens como Python, JavaScript, HTML/CSS, etc.`;
            }
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        setTimeout(() => {
            app.showNotification(
                ...
                'Interface universal de inteligência artificial. Clique em "Chat Inteligente" na sidebar para começar.',
                'info',
                'fa-robot'
            );
        }, 1000);
